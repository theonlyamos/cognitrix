...
declare module '$env/static/private' {
	...
	export const CLARIFAI_PAT: string;
	...
	export const SERPAPI_API_KEY: string;
	...
	export const VITE_DEEPGRAM_API_KEY: string;
