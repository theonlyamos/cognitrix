...
async def mcp_call_tool(tool_name: str, arguments: dict[str, Any] | None = None, server_name: str | None = None) -> str:
    """
    ...
    try:
        ...
        if result:
            ...
            return "Tool call failed or returned no result"

    except Exception as e:
        return f"MCP tool call failed: {e}"

async def mcp_list_tools(server_name: str | None = None) -> list[dict[str, Any]]:
    """
...
async def mcp_list_resources(server_name: str | None = None) -> list[dict[str, Any]]:
    """
