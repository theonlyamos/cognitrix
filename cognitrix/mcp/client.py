...
class DynamicMCPClient:
    ...
    async def list_tools(self, server_name: str) -> list[dict[str, Any]] | None:
    ...
    async def call_tool(self, server_name: str, tool_name: str, arguments: dict[str, Any]) -> Any | None:
    ...
    async def list_resources(self, server_name: str) -> list[dict[str, Any]] | None:
